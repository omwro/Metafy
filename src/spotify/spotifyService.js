...
export class SpotifyService {
    ...
    static async addSongToPlaylist(song, playlist) {
        await SpotifyRepository.addPlaylistTracks(playlist.id, [song.uri]);
        await store.dispatch("addSongTag", [song.id, playlist.id])
    }
